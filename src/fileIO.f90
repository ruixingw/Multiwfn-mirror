...
if (iorca==1.and.infomode==0) write(*,*) "This file is found to be generated by ORCA! Special treatment is applied..."
if (icfour==1.and.infomode==0) write(*,*) "This file is found to be generated by CFour! Special treatment is applied..."
