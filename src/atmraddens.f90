...
!
!Beware that the densities are truncated at 1D-8. This criterion cannot be further tighten, e.g. 1D-100, becuase if the value is very small, Lagrangian interpolation gives frantic result!
!Currently the largest distance actually used is posarr(171)= 17.53 Bohr = 9.28 Angstrom
!Largest distance of every element in this library is given in "atmrhocut" array in define.f90, generated by:
!do iele=1,103
!call genatmraddens(iele,posarr,rhoarr,npt)
!write(10,"(f12.2)") posarr(npt)
!end do
