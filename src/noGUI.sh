...
call drawdomaingui|call drawmolgui|call drawplanegui|call drawisosurgui|call drawmoltopogui|\
call drawsurfanalysis|call drawbasinintgui|call drawmol|call drawcurve|call drawscatter|\
call drawmatcolor|call drawplane|call useclrind|metafl|call window|scrmod|imgfmt|\
call page|disini|hwfont|axslen|axspos|wintit|call ticks|errmod|labdig|call name|\
setgrf|call graf|setrgb|call dash|call grid|call solid|call curve|call color|box2d|\
endgrf|xaxgit|disfin|disini|call ticks|errmod|legini|legtit|call frame|legpos|leglin|\
