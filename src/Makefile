...
#LIB = ./dislin_d-11.0.a -lXm -lGL #Works for CentOS 6.1
LIB = ./dislin_d-11.0.a -lXm -lXt -lX11 -lGL #Works for CentOS 7.2
FC = ifort
EXE = Multiwfn

objects = define.o util.o plot.o function.o GUI.o sub.o integral.o Lebedev-Laikov.o \
...
GUI.o : GUI.f90 define.o plot.o
	$(FC) $(OPT) -c GUI.f90

modules = define.o util.o function.o plot.o GUI.o
